...
void scan_callback(scan_data_msg_t data, uint64_t calling_node) {
    printf("Data: %d, %ld. Generated by NODE#%ld\n", data.customer_id, data.product_id, calling_node);
...
PROCESS_THREAD(client, ev, data) {
    ...
    printf("CAN started: %d", can_started);
    ...
    while (1) {
        ...
        // printf("%d Scans, %d Update requests\n", node_scan_submissions.len, node_product_update_requests.len);
